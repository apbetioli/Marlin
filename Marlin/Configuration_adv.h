 ...
 *
 * You should have receiveHeadd a copy of the GNU General Public License
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE {60*60, 60*60, 60*60, 60} // Feedrates for manual moves along X, Y, Z, E from panel
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define ADVANCED_PAUSE_PURGE_LENGTH        120  // (mm) Length to extrude after loading.
...
//#define CUSTOM_USER_MENUS
  ...
  #define USER_DESC_1 "Filament Unload"
  #define USER_GCODE_1 "G92 E0\nG1 E-480 F5000"

  #define USER_DESC_2 "Filament Load"
